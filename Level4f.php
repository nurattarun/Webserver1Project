...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($correct) {
        ...
        echo '<a href="Level5f.php">Next Level</a>';
    } else {
        echo '<p>Sorry, you sorted the numbers incorrectly. Please try again.</p>';
        echo '<p>Your Numbers: '.implode(', ', $answers).'</p>';
        echo '<a href="Level4f.php">Try Again</a>';
    }
} else {
    ...
    <link rel="stylesheet" href="Level3.css">
        <title>Game Level 4: Order numbers in descending order</title>
    </head>
    <body>
        <h1>Game Level 4: Order numbers in descending order</h1>
        <p>A set of 6 different numbers generated randomly is shown below. Please use the form available to write them in descending order (from 0 to 100).</p>
